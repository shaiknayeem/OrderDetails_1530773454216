package com.orderdetails.config;
...
import com.orderdetails.db.orderdetails_db.entity.User;
...
public class SwaggerConfiguration {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.orderdetails.controller"))
				.paths(regex("/.*")).build();
